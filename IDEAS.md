...
- i want to create a workflow like ARCHON to initiate some things and build a complete harness. (2026-08-08)
- i want to build skills that would be needed for validation in between. (2026-08-08)
